    ...
    <body>
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="#"><i class="fa fa-pencil-ruler"></i> Rascunhos</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h1>Rascunhos</h1>
                        <p>Termine de escrever ou revisar seus textos e envie quando quiser.</p>
                        <a href="redacao.php" class="btn btn-primary mb-5"><i class="fa fa-plus-circle"></i> Nova redação</a>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <?php
                            $rascunhos = buscarRascunhos();
                            if(!$rascunhos){
                        ?>
                        
                        <p class="text-muted">Você não tem rascunhos.</p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rascunho->getTitulo(); ?></td>
                                    <td><?php echo $rascunho->getData(); ?></td>
                                    <td><a href="#"><i class="fa fa-edit"></i> Revisar</a></td>
                                </tr>
